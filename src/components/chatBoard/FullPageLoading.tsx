...
export default function FullPageLoading({className}: Props) {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 bottom-0 w-full z-50 overflow-hidden bg-gray-700 bg-opacity-75 flex flex-col items-center justify-center ${className? className : ''}`}>
