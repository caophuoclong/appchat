  ...
  return (
    <div style={{ height: '10%' }} className={props.className}>
      ...
      <div className="relative justify-self-end ml-auto mr-4">
        {showModalOption ? (
          <ModalOptions className="flex flex-col p-4 pb-2 absolute w-80 min-h-40 bg-gray-50 -translate-y-full -translate-x-8 -top-1/2 left-full after:content-[''] after:border-l-8 after:border-l-transparent after:border-r-8 after:border-r-transparent after:border-t-8 after:border-t-gray-50 after:absolute after:bottom-0 after:translate-y-full after:left-4 shadow-2xl rounded-xl drop-shadow-2xl z-10" />
        ) : null}
        <button
